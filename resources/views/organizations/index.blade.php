...
<body class="antialiased bg-gray-100">
    ...
    <div class="container mx-auto py-8">
        ...
        <div class="flex justify-between mb-4">
            <div>
                <input type="text" class="border border-gray-300 p-2" placeholder="Search organizations">
            </div>
            <!-- Add a link to the create route using mustache syntax -->
            <a href="{{ route('organizations.create') }}"
                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                @svg('go-organization-16') <!-- Use it as a directive -->
                Add Organization
            </a>
        </div>
            ...
            <tbody>
                @forelse ($organizations as $organization)
                    <tr>
                        ...
                        <td class="px-4 py-2">{{ $organization->description }}</td>
                        <td class="px-4 py-2">
                ...
                @empty
                    <tr>
                        <td class="px-4 py-2" colspan="3">No organizations found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
